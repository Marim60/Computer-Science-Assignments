...
int main() {
    ...
    cout<<"\nTest31 before delete an interval\n";
    intervalTree6->inorder(intervalTree6);
    intervalTree6->deleteIntervalNode(intervalTree6,intervals6[1]);
    cout<<"\nTest31 after delete an interval\n";
    intervalTree6->inorder(intervalTree6);
