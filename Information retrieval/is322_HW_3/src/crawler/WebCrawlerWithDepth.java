...
//==============================================================================
    ...
    public void getPageLinks(String URL, int depth, invertedIndex.Index5 index) {
        ...
        if ((!(links.contains(URL)))
                ...
                && ((!URL.substring(12).contains(":")) || (depth == 0)) // ignore sublink that contain : bu pass the "http:"
            ...
            try {
                ...
                Document document = Jsoup.connect(URL).get(); // connect and extract web data
               ...
               String docText = "";
                ...
                //System.out.println("Done #" + sr.fid);
                plinks--;
            }
            catch (IOException e) {
...
//==============================================================================
    public static void main(String[] args) {
        ...
        index.find_07("narmer giza pyramid");
        //System.out.println("Cosine similarity ranking model result for 'narmer giza pyramid' = \n" + answer);
