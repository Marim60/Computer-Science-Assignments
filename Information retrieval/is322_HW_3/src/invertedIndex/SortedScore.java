...
class ScoreRecord {
   ...
   public ScoreRecord(double s, int id, String u, String t, String d) {
        fid = id;
        score = s;
        desc = d;
        title=t;
...
//------------------------------------------------
    void insertScoreRecord(double s, int i, String u, String t, String d) {
        insertScoreRecord(new ScoreRecord(s,i,u,t,d));
    }
//------------------------------------------------
    String printScores() {
        String scores="";
        ...
        while (p != null) {
            ...
            String str = i + " \t " +"score = " + String.format("%.3f", p.score) + " \t " +"fid = " + p.fid + " \t " + p.title+  "  \t\t" +p.URL ;
            scores += str+"<br>\n";
